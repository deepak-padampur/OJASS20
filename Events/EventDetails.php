...
<section style="overflow-x: hidden; height: inherit;;margin-left:65px;" id="home_section" class="section_banner section_gradiant3 ">
                ...
                <div class="details">
                  ...
                  <ul ng-if="event.name=='Jumbo Films'">
                    ...
                    <div ng-if="event.prize.firstyear">
                      ...
                      <b ng-if="event.name!='Hack-De-Science' && event.name!='FIFA\'19' ">First year : <br></b>
                      ...
                      <b ng-if="event.name!='Hack-De-Science' && event.name!='FIFA\'19' ">Second year : <br> </b>
    ...
    <script type="text/javascript">
        ...
        //  var html='<img src='+branches[branchname]+' class="event-img">';
          ...
          var html='<div class="event-details-preview row container-fluid"><div class="card-head-event col-md-4"><img src='+branches[branchname]+' class="event-imgs" style="z-index:5;display:block!important;margin-left:-18%;"/></div><div class="card-event-body col-md-8"><div class="event-desc"><div class="back-text-event"><span class="text" style="font-family:batman;font-size:42px;">'+branchname+'<br></span></div><div ng-if="!flag"><img src="../img/Infinity-1s-200px.svg"></div><span ng-if="flag" class="event-caption " style="margin-top:50%!important;"><br>{{about}}</span></div><br><strong ng-if="flag" ><u>BRANCH HEADS</u></strong><div class="row" style="justify-content:space-around;margin-top:1%;"> <div ng-if="flag"  ng-repeat="h in head" class="event-name ">{{h.name}} <div class="heads"> <img src={{h.url}} alt="Branch Head" style="width:110px;height:110px;" class="branch-heads"/><br><img src="https://img.icons8.com/plasticine/18/000000/phone.png">: &nbsp;{{h.cn}}<br><img src="https://img.icons8.com/doodle/18/000000/whatsapp.png">: &nbsp;{{h.wn}}</div></div></div> </div></div>'
          $('.imm').html(html);
