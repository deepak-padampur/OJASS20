<html>
  ...
  <!-- <section class="content" id="clients">
    <div class="sponsor-container1" style="">
        <h2>Title Sponsor</h2>
        <ul class="cards1">
            ...
            <li class="cards__item">
            <div class="card1" style="align-self: flex-start;">
    ...
    <div class="sponsor-container1" style="">
        ...
        <br>
        <br>
        <img src="../img/rellax/SVG/svgtitle/sponsors.svg" alt="" srcset="">
    <br><br>
