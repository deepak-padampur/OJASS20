    ...
    <section id="services" class="section-bg parallax">
      <div class="container">
        ...
        <header class="section-header">
          <br>
          <h3>Events</h3>
          <!-- <img src="../img/rellax/SVG/svgtitle/events.svg" alt="" srcset=""> -->
    <br>
          <!-- <p>Different events in OJASS'20</p> -->
        </header>
          <br>
        <div class="row">
          ...
          <!-- <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.2s" data-wow-duration="1.4s"> -->
            <!-- <div class="box">
              <div class="icon" style="background: #ecebff;">
              <a href="../Events/EventDetails.php?branch=Test_Event" target="_blank">
              <i class="ion-ios-clock-outline" style="color: #8660fe;"></i></a></div>
              <h4 class="title"><a href="../Events/EventDetails.php?branch=Test_Event" target="_blank">Test Event</a></h4>
              <p class="description">Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi</p>
            </div> -->
          <!-- </div> -->
