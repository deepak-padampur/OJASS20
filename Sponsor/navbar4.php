...
.date {
 ...
 <!--==========================
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
         ...
         <li><a href="../index.php#why-us" target="_blank">Celebrities</a></li>
          ...
          <li class="active"><a href="#clients">Sponsors</a></li>
  ...
  <div class="notifiation-panel" id="NotifPanel" style="background:aqua; width:20%;right:0!important;display:block;height:500px; margin-top:70px; position:fixed;z-index:1025;display:none;">
